...
As mentioned above, we'll be using an open vocabulary standard to describe our model. This allows us to attach real semantical meaning that it and created interoperability with other Data Publishers that use the same vocabulary.
